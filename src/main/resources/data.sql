...
insert into book (id, author, title, genre, releaser_id) values (100, 'Mashu', 'KouQ', 'NonFiction', 100)
insert into book(id, author, title, genre, releaser_id) values (101, 'Johnny', 'TFBF', 'Fiction', 100)
insert into book(id, author, title, genre, releaser_id) values (102, 'JohnnyMashu', 'Zed', 'SciFi', 101)
